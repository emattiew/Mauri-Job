                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input value="{{ $job->vacancy }}" type="number" min="1" placeholder="Nombre de postes" id="vacancy" name="vacancy" class="form-control">
                                    <p></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="mb-4 col-md-6">
                                    ...
                                    <div class="form-check-inline">
                                        ...
                                        <label class="form-check-label" for="status-block">Bloqué</label>
                                    </div>
                                </div>
                            </div>
