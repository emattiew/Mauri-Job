    ...
    <form action="{{route('account.updateJob',$job->id)}}" method="post" id="editJobForm" name="editJobForm">
        ...
        <div class="card border-0 shadow mb-4 ">
            <div class="card-body card-form p-4">
                <h3 class="fs-4 mb-1">modifier les détails de l'offre d'emploi</h3>
                <div class="row">
                    <div class="col-md-6 mb-4">
                        <label for="" class="mb-2">Titre<span class="req">*</span></label>
                        <input  value="{{ $job->title }}" type="text" placeholder="Titre du poste" id="title" name="title" class="form-control">
                        @error('title')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6  mb-4">
                        ...
                        <input value="{{ $job->vacancy }}" type="number" min="1" placeholder="Nombre de postes vacants" id="vacancy" name="vacancy" class="form-control">
                    </div>
                    @error('vacancy')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                ...
                <div class="mb-4">
                            ...
                            <select name="experience" id="experience" class="form-control">
                                  <option value="1" {{($job -> experience== 1 ) ? 'selected' : ''}} >1 ans</option>
                ...
                <div class="mb-4">
                    ...
                    <input value="{{ $job->company_website }}" type="text" placeholder="Site web" id="website" name="website" class="form-control">
                </div>
            </div> 
