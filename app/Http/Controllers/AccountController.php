...
return view('front.account.job.my-job-applications',[
    ...
    public function processForgotPassword(Request $request) {
        ...
        $mailData =  [
            'token' => $token,
            'user' => $user,
            'subject' => 'Vous avez demandé à changer votre mot de passe.',
        ];

        Mail::to($request->email)->send(new ResetPasswordEmail($mailData));

        return redirect()->route('account.forgotPassword')->with('success','Un email de réinitialisation du mot de passe a été envoyé dans votre boîte de réception.');
    ...
    public function processResetPassword(Request $request) {
        ...
        return redirect()->route('account.login')->with('success','Vous avez changé votre mot de passe avec succès.');
